    ...
    <footer className="border-t bg-muted/30">
      <div className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Your interactive guide to exploring the diverse continent of Africa through engaging quizzes and
              educational content.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/daily-challenge" className="text-muted-foreground hover:text-foreground">
                  Daily Challenge
                </Link>
              </li>
              <li>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Green Safari Guide. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <div className="inline-flex items-center rounded-full bg-muted px-3 py-1 text-xs">
